...
$yourEmail = "mark@silverheath.co.uk; // the email address you wish to receive these mails through
$yourWebsite = "History Blog"; // the name of your website
$thanksPage = '/cms/sent.php'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
